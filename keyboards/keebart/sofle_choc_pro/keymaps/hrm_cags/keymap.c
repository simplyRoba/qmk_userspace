...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [GAME] = LAYOUT_split_4x6_5(
        ...
        KC_LSFT,_______,_______,_______,_______, KC_B,    _______, _______, _______,_______,_______,_______,_______,_______,
                        _______,_______, KC_LALT, KC_LCTL, KC_SPC,  _______, _______,_______,_______,_______
    ),
